...
export function GenerationProgress({ completed, current }: { completed: number; current: PhaseKey | null }) {
  ...
  return (
    <div className="mx-auto max-w-xl px-5 py-24">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        Each part is generated and checked separately. This can take several minutes. Please keep this page open.
      </p>
