  ...
  head: () => ({
    meta: [
      ...
      { title: "TeacherFlow — One topic. One complete class." },
      {
        name: "description",
        content:
          "TeacherFlow turns one lesson idea into a classroom-ready English lesson package: plan, slides, worksheet, answer key, assessment and differentiation.",
      },
      { property: "og:title", content: "TeacherFlow — One topic. One complete class." },
      {
        property: "og:description",
        content: "Classroom-ready English lesson packages in minutes.",
      },
    ...
    links: [
      ...
      { rel: "icon", href: "/teacherflow-icon.svg", type: "image/svg+xml" },
    ],
  }),
